    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try
        {
            ...
            while(dis.available() >0) {
                ...
                String s;
                while ((s = String.valueOf(dis.readChar())) != System.lineSeparator()) {
                    line.append(s);

                }
                String realline = line.toString();
                if (realline.matches("Level")) {
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, final View view,
                ...
                levelgiver.putExtra("LX",sokolevels.get(position).lx);
                levelgiver.putExtra("LY",sokolevels.get(position).ly);
                levelgiver.putExtra("MAP",sokolevels.get(position).map);
