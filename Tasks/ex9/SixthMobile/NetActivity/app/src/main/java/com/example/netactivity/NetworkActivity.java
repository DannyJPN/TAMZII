...
public class NetworkActivity extends Activity {
    ...
    private class DownloadXmlTask extends AsyncTask<String, Void, List<Entry>> {
        ...
        protected void onPostExecute(List<Entry> result) {
          ...
          //  result.get(i).vlajka = getResources().getDrawable(R.drawable.);
            ...
            lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    result.putExtra("country",item.stat);
                    result.putExtra("mena",item.mena);
                    result.putExtra("price",item.cena);
                    result.putExtra("code",item.kod);
                    result.putExtra("flagid",item.flagid);
    ...
    private List<Entry> loadXmlFromNetwork(String urlString) throws XmlPullParserException, IOException, ParseException {
